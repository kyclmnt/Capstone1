            ...
            <span class="d-flex">
                <div class="d-flex flex-column flex-grow-1">
                    <div>
                        ...
                        <input type="numeric" class="schoolyear" name="from" required />
                        <input type="numeric" class="schoolyear" name="to" required />
                    </div>
                    ...
                    <div required>
                        <select class="gradelevel">
                            ...
                            <option id="grade11" name="gradelevel" value="11">Grade 11</option>
                            <option id="grade12" name="gradelevel" value="12">Grade 12</option>
                        </select>
                    </div>
                </div>
                <div class="box">
                    ...
                    <div class="lrn">
                        <p>1. With LRN?</p>
                        <input type="radio" class="Ylrn" name="withlrn" id="Ylrn" value="yes">
                        <label for="Ylrn">Yes</label>
                        <br>
                        <input type="radio" class="Ylrn" name="withlrn" id="Nlrn" value="no">
                        <label for="Nlrn">No</label>
                    </div>

                    <div class="return">
                        <p>2. Returning (Balik Aral)</p>
                        <input type="radio" class="Yreturn" name="returning" id="Yreturn" value="yes">
                        <label for="Yreturn">Yes</label>
                        <br>
                        <input type="radio" class="Yreturn" name="returning" id="Nreturn" value="no">
